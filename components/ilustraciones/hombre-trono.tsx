...
const DETALLES: Record<string, { correa: string; camisa: string; nombre: string }> = {
  ...
  zamarrilla: { correa: "#1E0A24", camisa: "#FFFFFF", nombre: "La Zamarrilla" },
 ...
 * característica de las cuadrillas cofrades. Colores por hermandad.
 */
  ...
  return (
    ...
    >
      <svg viewBox="0 0 120 200" className="h-44 w-auto" role="img" aria-label={`Uniforme de hombres de trono de ${d.nombre}`}>
        {/* Cabeza */}
        <circle cx="60" cy="26" r="14" fill="#E8C39E" stroke="#C5A059" strokeOpacity="0.4" />
        {/* Camisa */}
        ...
        {/* hebilla dorada */}
        <circle cx="60" cy="74" r="4.5" fill="#C5A059" />
        {/* Pantalón */}
        ...
        {/* Farol de trabajo */}
        <g>
          <rect x="90" y="88" width="12" height="16" rx="2" fill="#C5A059" opacity="0.9" />
          <rect x="92.5" y="90.5" width="7" height="11" fill="#FEF3C7" />
          <path d="M96 88 L96 80" stroke="#C5A059" strokeWidth="2" />
        </g>
      </svg>
